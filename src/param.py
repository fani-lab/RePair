...
settings = {
    ...
    'aol': {
        'index_item': 'text',# acceptable values 'text','title'
        'index': '../data/raw/aol/indexes/',
        'pairing': ['userid', 'query', 'doc'] #[context={2 scenarios, one with userID and one without userID). input={'userid','query','doc(s)'} output={'query','doc(s)'}
    }
}